...
<head>
    ...
    <!-- CSS -->
    <link href="/imachan/css/bootstrap.min.css" rel="stylesheet" type="text/css">
    <link href="/imachan/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
	<link href="/imachan/css/nivo-lightbox.css" rel="stylesheet" />
	<link href="/imachan/css/nivo-lightbox-theme/default/default.css" rel="stylesheet" type="text/css" />
	<link href="/imachan/css/owl.carousel.css" rel="stylesheet" media="screen" />
    <link href="/imachan/css/owl.theme.css" rel="stylesheet" media="screen" />	
	<link href="/imachan/css/animate.css" rel="stylesheet" />
    <link href="/imachan/css/style.css" rel="stylesheet">
	<link href="/imachan/color/default.css" rel="stylesheet">
...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
    ...
    <script src="/imachan/js/jquery.min.js"></script>
    <script src="/imachan/js/bootstrap.min.js"></script>
    <script src="/imachan/js/jquery.easing.min.js"></script>	
	<script src="/imachan/js/jquery.sticky.js"></script>
	<script src="/imachan/js/jquery.scrollTo.js"></script>
	<script src="/imachan/js/stellar.js"></script>
	<script src="/imachan/js/wow.min.js"></script>
	<script src="/imachan/js/owl.carousel.min.js"></script>
	<script src="/imachan/js/nivo-lightbox.min.js"></script>
    <!-- Custom Theme JavaScript -->
    <script src="/imachan/js/custom.js"></script>
